...
/*
 * for SBM_RUMB: (v1.0) 
 * bareGauss, Gauss, 2Gauss in interaction_function
 */
...
#ifdef SBM_RUMB
    def_bondedz ("BARE_GAUSS","bare Gaussian",  2, 3, 0,  eNR_BAREGAUSS, baregauss  ),
    def_bondedz ("GAUSS",    "Gaussian",        2, 4, 0,  eNR_GAUSS, gauss          ),
    def_bondedz ("2GAUSS",   "2 Gaussian",      2, 6, 0,  eNR_TWOGAUSS, twogauss    ),
    def_bondedz ("PUMBRELLA","Umbrella",        2, 3, 0,  eNR_PUMBRELLA, pair_umbrella),
#endif // SBM_RUMB
