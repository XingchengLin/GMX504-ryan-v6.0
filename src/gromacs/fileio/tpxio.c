 ...
 * for SBM_RUMB: (v1.0)
 * set version to 95
 * F_GAUSS, F_BAREGAUSS, F_TWOGAUSS, in ftupd & do_iparams
 */
#ifdef HAVE_CONFIG_H
#include <config.h>
#endif
...
#ifdef SBM_RUMB
static const int tpx_version = tpxv_SBM_RUMB;
#else
...
static const t_ftupd ftupd[] = {
   ...
   { 43, F_TABDIHS           },
#ifdef SBM_RUMB
   { tpxv_SBM_RUMB, F_GAUSS           },
   { tpxv_SBM_RUMB, F_BAREGAUSS       },
   { tpxv_SBM_RUMB, F_TWOGAUSS        },
   { tpxv_SBM_RUMB, F_PUMBRELLA       },
#endif // SBM_RUMB
   { 65, F_CMAP              },
   { 60, F_GB12              },
   { 61, F_GB13              },
...
#ifdef SBM_RUMB
      case F_GAUSS:
	 gmx_fio_do_real(fio,iparams->gauss.amp);
	 gmx_fio_do_real(fio,iparams->gauss.mu);
	 gmx_fio_do_real(fio,iparams->gauss.sigma);
	 gmx_fio_do_real(fio,iparams->gauss.rad);
	 break;
      case F_BAREGAUSS:
	 gmx_fio_do_real(fio,iparams->baregauss.amp);
	 gmx_fio_do_real(fio,iparams->baregauss.mu);
	 gmx_fio_do_real(fio,iparams->baregauss.sigma);
	 break;
      case F_TWOGAUSS:
	 gmx_fio_do_real(fio,iparams->twogauss.amp);
	 gmx_fio_do_real(fio,iparams->twogauss.mu1);
	 gmx_fio_do_real(fio,iparams->twogauss.sigma1);
	 gmx_fio_do_real(fio,iparams->twogauss.mu2);
	 gmx_fio_do_real(fio,iparams->twogauss.sigma2);
	 gmx_fio_do_real(fio,iparams->twogauss.rad);
	 break;
      case F_PUMBRELLA:
	 gmx_fio_do_real(fio,iparams->pumbrella.amp);
	 gmx_fio_do_real(fio,iparams->pumbrella.mu);
	 gmx_fio_do_real(fio,iparams->pumbrella.sigma);
	 break;
#endif // SBM_RUMB
