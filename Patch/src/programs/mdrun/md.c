...
#ifdef SBM_RUMB
extern void Init_Umbrella_Communicate(t_commrec *cr);
extern void Free_Umbrella_Communicate(void);
#endif // SBM_RUMB
             ...
             gmx_walltime_accounting_t walltime_accounting)
{
    ...
    // #pragma omp master
    // {
    //     fprintf(stderr,"One thread doing Init_Umbrella_Communicate\n");
    // Other threads haven't started yet
        Init_Umbrella_Communicate(cr);
    // }
#endif // SBM_RUMB
    ...
    // #pragma omp master
    {
        fprintf(stderr,"One thread doing Free_Umbrella_Communicate\n");
        Free_Umbrella_Communicate();
    }
#endif // SBM_RUMB
