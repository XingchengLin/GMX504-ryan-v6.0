 ...
 */
/* 
 * for SBM_RUMB: (v1.0) treatment of default parameters for
 *                 Gauss, etc in push_bond():
 *                 do not set, expect input
 */
               ...
               warninp_t wi)
{
    ...
    else if (ftype == F_LJC_PAIRS_NB)
    {
        ...
        bFoundB = TRUE;
#ifdef SBM_RUMB
    } else if (ftype == F_GAUSS || ftype == F_BAREGAUSS || ftype == F_TWOGAUSS || ftype == F_PUMBRELLA ) {
        bFoundA = FALSE ;
        bFoundB = TRUE  ;
#endif // SBM_RUMB
    }
